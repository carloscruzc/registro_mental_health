...
?>
    ...
    <main class="main-content mt-0 ps">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../../../assets/img/curved-images/fondo_claro_mental.png');">
                    ...
                    <div class="card z-index-0">
                        <div class="card-body pt-1">
                                ...
                                <div class="card-body px-lg-2 py-lg-2 text-center">
                                        <div class="info mb-2">
                                            <div class="icon icon-shape icon-xl rounded-circle bg-gradient-faded-danger shadow text-center py-3 mx-auto" style="color: #6238F6;">
                                        ...
                                        <form class="form-horizontal" id="code_form" action="/Register/Data" method="POST">
                                            ...
                                            <div class="text-center">
                                                <button style="color: #6238F6;" class="btn bg-gradient-faded-danger w-100 my-0 mb-2 ms-auto" type="submit" id="btn_registro_email"><b style="color: #FFFFFF">Verifique su código</b></button>
